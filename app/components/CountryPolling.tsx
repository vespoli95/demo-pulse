    ...
    datasets: [
      {
        label: "Liberal Party",
        data: [
          32.1, 31.8, 31.5, 31.2, 30.9, 30.6, 30.3, 30.0, 29.7, 29.4, 29.1,
          28.8, 28.5, 28.3, 28.1, 27.9, 27.7, 27.5, 27.3, 27.1, 26.8, 26.5,
          26.2, 25.9, 25.6, 25.4, 25.2, 25.0, 24.7, 24.4, 24.1, 23.8, 23.5,
          23.3, 23.2, 23.0, 23.3, 23.6, 23.9, 24.2, 24.5, 24.8, 25.1, 25.4,
          25.7, 26.0, 26.3, 26.6, 26.9, 27.2, 27.5, 27.8, 28.1, 28.4, 28.7,
          29.0,
        ],
      ...
      },
      {
        ...
        data: [
          33.2, 33.5, 33.8, 34.1, 34.4, 34.7, 35.0, 35.3, 35.6, 35.9, 36.2,
          36.5, 36.8, 37.1, 37.4, 37.7, 38.0, 38.3, 38.6, 38.9, 39.2, 39.5,
          39.8, 40.1, 40.4, 40.7, 41.0, 41.3, 41.1, 40.9, 40.7, 40.5, 40.3,
          40.1, 39.9, 39.7, 39.5, 39.3, 39.1, 38.9, 38.7, 38.5, 38.3, 38.1,
          37.9, 37.7, 37.5, 37.3, 37.1, 36.9, 36.7, 36.5, 36.0, 35.7, 35.4,
          35.1,
        ],
      ...
      },
      {
        label: "NDP",
        data: [
          20.0, 20.0, 20.0, 20.0, 20.0, 19.9, 19.8, 19.7, 19.6, 19.5, 19.4,
          19.3, 19.2, 19.1, 19.0, 18.9, 18.8, 18.7, 18.6, 18.5, 18.4, 18.3,
          18.2, 18.1, 18.2, 18.4, 18.6, 18.8, 19.0, 19.2, 19.4, 19.6, 19.8,
          20.0, 20.2, 20.4, 20.6, 20.8, 21.0, 21.2, 21.4, 21.6, 21.8, 22.0,
          21.8, 21.6, 21.4, 21.2, 21.0, 20.8, 20.6, 20.4, 20.8, 20.9, 21.0,
          21.1,
        ],
      ...
      },
      {
        ...
        data: [
          7.8, 7.8, 7.9, 7.9, 8.0, 8.0, 8.1, 8.1, 8.2, 8.2, 8.2, 8.3, 8.3, 8.3,
          8.4, 8.4, 8.4, 8.5, 8.5, 8.5, 8.6, 8.6, 8.7, 8.7, 8.7, 8.8, 8.8, 8.8,
          8.8, 8.9, 8.9, 8.9, 9.0, 9.0, 9.0, 9.0, 9.1, 9.1, 9.1, 9.1, 9.1, 9.0,
          9.0, 9.0, 8.9, 8.9, 8.8, 8.8, 8.7, 8.7, 8.6, 8.6, 8.5, 8.5, 8.4, 8.4,
        ],
      ...
      },
      {
        label: "Green Party",
        data: [
          3.5, 3.5, 3.4, 3.4, 3.3, 3.3, 3.3, 3.2, 3.2, 3.2, 3.1, 3.1, 3.1, 3.0,
          3.0, 3.0, 3.0, 3.1, 3.1, 3.1, 3.2, 3.2, 3.2, 3.3, 3.3, 3.3, 3.4, 3.4,
          3.4, 3.5, 3.5, 3.5, 3.6, 3.6, 3.6, 3.7, 3.7, 3.7, 3.8, 3.8, 3.8, 3.8,
          3.7, 3.7, 3.7, 3.6, 3.6, 3.6, 3.5, 3.5, 3.4, 3.4, 3.4, 3.3, 3.3, 3.3,
        ],
